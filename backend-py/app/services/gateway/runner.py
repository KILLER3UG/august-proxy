...
_adapter_factories: dict[str, Callable[..., BasePlatformAdapter]] = {}


def register_adapter(name: str, factory: Callable[..., BasePlatformAdapter]) -> None:
...
class GatewayRunner:
    ...
    async def start(self) -> None:
        ...
        self._bridge = SessionBridge(
            ...
            guard_mode=cfg.get("guard_mode", "full"),
        )
...
async def start_gateway(settings: Any) -> GatewayRunner:
