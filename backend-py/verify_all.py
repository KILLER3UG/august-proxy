...
from app.services.memory_store import init, get_stats
init()
stats = get_stats()
...
# 6. Heuristics CRUD
print("\n6. Heuristics CRUD...")
from app.services.heuristics_service import add_heuristic, count_heuristics
n1 = count_heuristics()
...
# 7. Blackboard CRUD
print("\n7. Blackboard CRUD...")
from app.services.blackboard_service import write_note, read_notes, clear_notes
...
# 8. Token budget
print("\n8. Token budget...")
from app.services.workbench.token_budget import estimate_tokens, compute_budget, get_critical_threshold
