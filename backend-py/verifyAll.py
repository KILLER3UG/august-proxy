...
for t in ['memory_store_fts_ai', 'memory_store_fts_ad', 'memory_store_fts_au', 'auto_memories_ai', 'auto_memories_ad', 'auto_memories_au']:
    if t in triggers:
        print(f'  {t}: OK')
    else:
...
catalog = buildToolCatalog([{'name': 'read_file', 'description': 'Read files', 'input_schema': {'properties': {'path': {}}}}, {'name': 'web_fetch', 'description': 'Fetch URLs', 'input_schema': {'properties': {'url': {}}}}])
...
print('\n12. Compile check...')
files = ['app/services/memory_store.py', 'app/services/memory/auto_memory.py', 'app/services/memory/context_builder.py', 'app/services/daemon_manager.py', 'app/services/blackboard_service.py', 'app/services/consolidation_daemon.py', 'app/services/delta_engine.py', 'app/services/environment_watcher.py', 'app/services/heuristics_service.py', 'app/services/db_writer.py', 'app/services/tool_definitions.py', 'app/services/tool_registry.py', 'app/services/tools/retrieval.py', 'app/services/tools/model_tools.py', 'app/services/tools/tool_bridges.py', 'app/services/tools/skill_manifest.py', 'app/services/workbench/workbench.py', 'app/services/workbench/token_budget.py', 'app/services/workbench/tool_guardrails.py', 'app/services/workbench/prompt_cache.py', 'app/routers/brain.py', 'app/routers/exam.py', 'app/main.py']
count = 0
for f in files:
    try:
