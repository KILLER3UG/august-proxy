...
_TELEGRAMUpdate = {'update_id': 100, 'message': {'message_id': 42, 'from': {'id': 123, 'is_bot': False, 'first_name': 'Tester'}, 'chat': {'id': -456, 'type': 'group', 'title': 'Test Group'}, 'text': 'Hello, bot!', 'message_thread_id': 7}}
