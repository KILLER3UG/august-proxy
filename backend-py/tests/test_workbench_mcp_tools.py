...
def _seedMcpCache():
    ...
    mcp_client._toolsCache[MCP_SERVER_ID] = [
        {
            'name': 'summarize',
...
def testAssembleToolDefsKeepsMcpToolsAsCore():
    ...
    bigDeferrable = [
        {'name': f'big_tool_{i}', 'description': 'x' * 200, 'input_schema': {'type': 'object'}} for i in range(300)
    ]
    mcpTools = [
    ...
    result = assembleToolDefs(allTools, context_messages=None, contextLength=200000)
