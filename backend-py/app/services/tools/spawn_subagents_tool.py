...
# Tool registration lives in app/services/tool_registrations/agent_tools.py
# (the schema and description are owned by the registration site so policy
# parity oracles can audit them).
