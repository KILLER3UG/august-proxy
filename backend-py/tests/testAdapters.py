"""Adapter unit tests."""
import pytest
from app.adapters.toolClassification import getToolNameFromOpenaiTool, getToolNameFromAnthropicTool, classifyOpenaiToolCalls, classifyAnthropicToolUses
from app.adapters.proxyTools import isManagedWebToolName, isManagedBashToolName, openaiToAnthropicToolDefinition, anthropicToOpenaiToolDefinition, getManagedAnthropicWebToolDefinitions, sanitizeAnthropicToolDefinition, dedupeAndCanonicalizeAnthropicTools, isBrowserAutomationToolName, formatManagedWebResult
