...
def testBuildSystemPromptAcceptsCachedT12():
    ...
    result = buildSystemPrompt(
        session={'id': 'test'}, memory={}, tools=[], agent_context=None, cached_t12='<cached Tier 1+2 content>'
    )
...
def testCachedT12ShortCircuitsT1T2():
    ...
    result = buildSystemPrompt(
        session={'id': 'test', 'user_state': {'profile': 'should not appear'}}, memory={}, cached_t12=cachePayload
    )
